**Archive note**: this repo has been merged into my main dotfiles [[here][https://github.com/VTimofeenko/monorepo-machine-config/tree/master/flake-modules/emacs].
